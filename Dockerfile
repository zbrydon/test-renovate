...
FROM node:26-alpine AS test-hub-official
...
FROM gcr.io/distroless/nodejs24-debian13@sha256:e7b49c7570331548957099e4c53d1b7255605dd20b0c56ee368077c07c1b170b AS runtime
